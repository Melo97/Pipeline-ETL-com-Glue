...
vendas_zoop_dyf = glueContext.create_dynamic_frame.from_catalog(database='db-glue', table_name='etl-vendas_zoop_bronze_parquet')
...
s3output = glueContext.getSink(
  path="s3://etl-com-glue/silver/vendas/", # adicione o nome do seu bucket no path
  connection_type="s3",
...
s3output.setCatalogInfo(
  catalogDatabase="db-glue", catalogTableName="etl-vendas_zoop_silver"
)

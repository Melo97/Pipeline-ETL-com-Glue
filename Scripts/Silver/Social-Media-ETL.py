...
redes_sociais_zoop_dyf = glueContext.create_dynamic_frame.from_catalog(database='db-glue', table_name='etl-redes_sociais_zoop_bronze_parquet')
...
s3output = glueContext.getSink(
  path="s3://etl-com-glue/silver/redes-sociais/",   # adicione o nome do seu bucket no path
  connection_type="s3",
...
s3output.setCatalogInfo(
  catalogDatabase="db-glue", catalogTableName="etl-redes_sociais_zoop_silver"
)
